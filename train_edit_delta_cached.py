...
LAMBDA_PROMPT = 1.0
LAMBDA_DELTA = 0.05
LAMBDA_PRESERVE = 0.05  # provisional RGB/silhouette preserve
N_RENDER_VIEWS = 3
RENDER_RES = 128
SAVE_EVERY = 1
PROMPTS_PER_OBJECT = 2
MAX_OBJECTS = 5  # limit objects to save memory
TEXT_GAIN = 4.0
TEXT_REPEAT = 8
...
def main():
    ...
    device = "cuda"
    output_dir = Path("/workspace/edit_checkpoints")
    ...
    for epoch in range(N_EPOCHS):
        ...
        import json
        pairs_json = Path("/workspace/edit_training_data/training_pairs.json")
